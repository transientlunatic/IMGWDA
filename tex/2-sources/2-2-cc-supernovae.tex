...
\sidebar{
  \includegraphics{figures/source-ccsn.pdf}
  \captionof{figure}{The expected frequency spectrum of a core collapse supernova at a distance of \SI{10}{\kilo\parsec} \cite{2008PhRvD..78f4056D}\label{fig:source-ccsn}}
  }
...
\sidebar{
  \includegraphics{figures/source-t1asn.pdf}
  \captionof{figure}{The expected frequency spectrum of a Type Ia supernova at a distance of \SI{30}{\kilo\parsec} \cite{2008PhRvD..78f4056D}\label{fig:source-t1asn}}
  }
