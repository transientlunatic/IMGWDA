...
** Gravitational wave burst detection
   /This should be a brief overview of how Burst detection is attempted, and a summary of the various pipelines which exist, to motivate the need for a common MDC set./
