...
#+BEGIN_definition
A gls:gaussian-process is a collection of random variables, any finite number of which have a joint Gaussian distribution\nbsp{}cite:gpr.book.rw.
#+END_definition
...
** Fully information-driven design
   :PROPERTIES:
   :CUSTOM_ID: sec:gpr:design:information
   :END:
