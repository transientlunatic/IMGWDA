...
*** DECIGO
    ...
    A gls:decigo cluster will consist of three spacecraft in a triangular configuration, forming three gls:fabry-perot cavities with lengths around $\SI{1000}{\kilo\meter}$. 
...
* A network of detectors                                            :section:
