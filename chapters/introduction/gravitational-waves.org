...
*** Antenna response of the detector
    ...
    \end{align}
for $\psi$ the polarisation angle of the abbr:gw, which corresponds to the rotation of the basis vectors defining the polarisations of the abbr:gw compared to the detector cite:cite:2009LRR....12....2S.
