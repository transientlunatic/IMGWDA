...
\end{tikzpicture}
\caption{The effect of a $+$-polarised abbr:gw on a circle of test particles as it propogates through the page (orthogonal to the ring). 
...
\begin{figure}[h]
 ...
 \end{tikzpicture}
\caption{The effect of a $\cross$-polarised abbr:gw on a circle of test particles as it propogates through the page (orthogonal to the ring). 
\label{fig:intro:gw:prop-plus}}
\end{figure}
...
** Observing run 2 and GW170817
 ...
 Nine detections were made during O2, of which eight were abbr:bbh events, and one was a gls:bns event.
