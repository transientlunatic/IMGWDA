...
\caption[Beaming angle posteriors for the 2016--2017 observing scenario]{The procedure used to produce figure~\ref{fig:grb:validation:results:2015} was repeated for the observing time and the horizon distance of the 2016--2017 observing scenario, with an observed abbr:sgrb event rate of $\SI{28.0}{\giga \parsec^{-3} \year^{-1}}$ used to induce a beaming angle of $\theta \approx 10^{\circ}$.
