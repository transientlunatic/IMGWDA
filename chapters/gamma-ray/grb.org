...
This classification also demonstrats a bimodality in the distribution of spectral hardness of the events.
...
\caption[Beaming angle posteriors for the 2016--2017 observing scenario]{The procedure used to produce figure~\ref{fig:grb:validation:results:2015} was repeated for the observing time and the horizon distance of the 2016--2017 observing scenario, with an observed abbr:sgrb event rate of $28.0 \,\giga \parsec^{-3}\,\yr^{-1}$ used to induce a beaming angle of $\theta \approx 10^{\circ}$.
...
\begin{figure}
\centering
{\includegraphics[width=\linewidth]{figures/grb/o5_violin.pdf}}
...
Both of the posteriors of each of these scenarios are plotted in figures ref:fig:grb:results:2016 and fig:ref:grb:results:2017 respectively.
