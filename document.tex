...
\chapterprecis{In this chapter I introduce the use of Gaussian process regression as a surrogate modelling method for \gls{gw} waveforms from compact binary coalescence events.
  
  Some of the work presented in this chapter has previously been made available on the ArXiv \cite{2019arXiv190309204W}, and at the time of writing is under review for publication. 
