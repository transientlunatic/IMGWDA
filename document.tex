...
\chapterprecis{
  In this chapter I introduce the use of Gaussian process regression as a surrogate modelling method for abbr:gw waveforms from compact binary coalesensce events.
